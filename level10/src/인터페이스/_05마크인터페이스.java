...
class Tank extends GrountUnit implements Repairable{
...
class Soldier extends GrountUnit{
...
class SCV extends GrountUnit implements Repairable{

	public SCV() {
		super(130);
	}
	
	void repairUnit(Repairable repairable) { // Repairable 상속 받은애만 들어와
